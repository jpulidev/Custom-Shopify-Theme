        ...
        value: function _rerender() {
          ...
          return fetch(url, {
            ...
            content.text().then(function (html) {
              ...
              var minicartDiv = myDiv.querySelector("#mini-cart");

              if (minicartDiv && minicartDiv.hasAttribute("data-item-count")) {
                _this2.itemCount = parseInt(
                  minicartDiv.getAttribute("data-item-count")
                );
              }

              if (minicartDiv && minicartDiv.hasAttribute("data-total-price")) {
                _this2.totalPrice =
                  minicartDiv.getAttribute("data-total-price");
              }
              _this2.element.querySelector(".header__cart-count").textContent =
                _this2.itemCount;
              _this2.element.querySelector(".header__cart-total").textContent =
                _this2.totalPrice;
      ...
      },
      {
        ...
        value: function _setupCollapsibles() {
          var collapsibleToggles = this.element.querySelectorAll(
            ...
            isPhone = Responsive.matchesBreakpoint("tablet-sm");
